...
// ============================================================
// 航路データ (Fairways & Buoys) — 海図完全準拠（方位角の傾き補正版）
// ============================================================
const FAIRWAYS = [
  {
    name: "URAGA SUIDO",
    // 浦賀水道：方位角 325度（北西へ向かう斜めのライン）
    leftBound: [
      { lat: 35.180, lon: 139.795 }, // 浦賀水道南口 (西側)
      { lat: 35.250, lon: 139.760 }, // 観音崎沖
      { lat: 35.310, lon: 139.730 }  // 第二海堡付近
    ],
    rightBound: [
      { lat: 35.180, lon: 139.825 }, // 浦賀水道南口 (東側)
      { lat: 35.250, lon: 139.790 }, // 観音崎沖（対岸）
      { lat: 35.310, lon: 139.760 }  // 富津岬西側
    ],
    center: { lat: 35.245, lon: 139.775 }
  },
  {
    name: "NAKANOSE",
    // 中ノ瀬：方位角 021度（北東へ向かう斜めのライン）。これで直進による浅瀬との衝突を回避！
    leftBound: [
      { lat: 35.320, lon: 139.735 }, // 中ノ瀬南口 (浅瀬の西側を避ける)
      { lat: 35.400, lon: 139.780 }  // 本牧沖（北東へシフト）
    ],
    rightBound: [
      { lat: 35.320, lon: 139.765 }, // 中ノ瀬南口
      { lat: 35.400, lon: 139.810 }  // 本牧沖
    ],
    center: { lat: 35.360, lon: 139.765 }
  }
];
...
const BUOYS = [
  // 浦賀水道航路 (緑: 左舷, 赤: 右舷)
  { name: "U1", lat: 35.180, lon: 139.795, color: "#11cc11" },
  { name: "U2", lat: 35.180, lon: 139.825, color: "#ee1111" },
  { name: "U3", lat: 35.250, lon: 139.760, color: "#11cc11" },
  { name: "U4", lat: 35.250, lon: 139.790, color: "#ee1111" },
  { name: "U5", lat: 35.310, lon: 139.730, color: "#11cc11" },
  { name: "U6", lat: 35.310, lon: 139.760, color: "#ee1111" },
  // 中ノ瀬航路 (北東に傾け、浅瀬を東側に迂回)
  { name: "N1", lat: 35.320, lon: 139.735, color: "#11cc11" },
  { name: "N2", lat: 35.320, lon: 139.765, color: "#ee1111" },
  { name: "N7", lat: 35.400, lon: 139.780, color: "#11cc11" },
  { name: "N8", lat: 35.400, lon: 139.810, color: "#ee1111" },
  // ランドマーク（完璧に位置が合った座標）
