...
// ============================================================
// 航路データ (Fairways & Buoys) — WGS84 正確な緯度経度ベース（完全版）
// ============================================================
const FAIRWAYS = [
  {
    name: "URAGA SUIDO",
    // 左舷側（西側・観音崎側）
    leftBound: [
      { lat: 35.180, lon: 139.770 }, // 浦賀水道南口
      { lat: 35.260, lon: 139.760 }, // 観音崎沖
      { lat: 35.310, lon: 139.750 }  // 第二海堡付近
    ],
    // 右舷側（東側・富津岬側）
    rightBound: [
      { lat: 35.180, lon: 139.795 }, // 浦賀水道南口
      { lat: 35.260, lon: 139.785 }, // 観音崎沖（対岸）
      { lat: 35.310, lon: 139.775 }  // 富津岬付近
    ],
    center: { lat: 35.245, lon: 139.772 }
  },
  {
    name: "NAKANOSE",
    // 左舷側（西側）
    leftBound: [
      { lat: 35.320, lon: 139.750 }, // 中ノ瀬南口
      { lat: 35.400, lon: 139.750 }  // 本牧沖
    ],
    // 右舷側（東側）
    rightBound: [
      { lat: 35.320, lon: 139.770 }, // 中ノ瀬南口
      { lat: 35.400, lon: 139.770 }  // 本牧沖
    ],
    center: { lat: 35.360, lon: 139.760 }
  }
];
...
const BUOYS = [
  // 浦賀水道航路 (緑: 左舷, 赤: 右舷)
  { name: "U1", lat: 35.180, lon: 139.770, color: "#11cc11" },
  { name: "U2", lat: 35.180, lon: 139.795, color: "#ee1111" },
  { name: "U3", lat: 35.260, lon: 139.760, color: "#11cc11" },
  { name: "U4", lat: 35.260, lon: 139.785, color: "#ee1111" },
  { name: "U5", lat: 35.310, lon: 139.750, color: "#11cc11" },
  { name: "U6", lat: 35.310, lon: 139.775, color: "#ee1111" },
  // 中ノ瀬航路
  { name: "N1", lat: 35.320, lon: 139.750, color: "#11cc11" },
  { name: "N2", lat: 35.320, lon: 139.770, color: "#ee1111" },
  { name: "N7", lat: 35.400, lon: 139.750, color: "#11cc11" },
  { name: "N8", lat: 35.400, lon: 139.770, color: "#ee1111" },
  // ★位置を完璧に修正したランドマーク
